# Generated by Django 2.2.1 on 2019-05-21 10:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='product_master.Product')),
        ...
        migrations.AddField(
            model_name='product',
            name='subcategory',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product_master.SubCategory'),
        ),
    ]
